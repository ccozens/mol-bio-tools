...
export const AnalyseProtein = () => {
  ...
  const [input, setInput] = useState(tgo.protein);
  ...
  return (
    ...
    >
      ...
      <div className="p-2 text-lg flex ">
        <p>
          Enter protein here in single letter format (eg MILD) format:
        </p>
        <a
          className="mx-auto py-1 px-8 text-sm w-fit border rounded cursor-pointer switch border-slate-600 bg-amber-200/50 hover:amber-200 hover:border-slate-400"
          href="#Reformat protein"
        >
          Convert three letter to single letter (MetIleLeuAsp -&gt;
          MILD){' '}
        </a>
      </div>
      ...
      <div
        className="xl:h-60 p-2 mt-2 text-base border rounded border-slate-600 bg-amber-200/50 min-h-16"
