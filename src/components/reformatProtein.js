...
export const ReformatProtein = () => {
  ...
  const handleClick = (event) => {
    ...
    const [convertedProtein, setconvertedProtein] = useState(convertThreeToOneLetter(checkedProtein));
  ...
  return (
    ...
    >
      ...
      { checkedProtein.includes('Non-') === true ? 
                <p className="text-lg text-center bg-orange-500/50 font-semibold my-1" > {checkedProtein}</p> : <p></p>}
      <a
